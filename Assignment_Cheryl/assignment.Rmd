...
packages = c('readr', 'tidyverse', 'dplyr', 'plotly', 'DT', 'formattable', 'scales', 'paletteer', 'crosstalk', 'shiny', 'reactable', 'knitr', 'RColorBrewer', 'scales', 'gt', 'GGally', 'RColorBrewer', 'readxl')
