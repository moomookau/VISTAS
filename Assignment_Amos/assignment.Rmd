...
packages = c('tidyverse', 'readxl', 'maps', 'geosphere', 'sf', 'leaflet', 'rworldmap', 'networkD3', 'chorddiag', 'randomcoloR', 'CGPfunctions')
...
industryCountry <- "Moldova"
industrySection <- "Manufacturing"

industrySlopeDf <- industryMigrationPivot %>%
  filter(country_name == industryCountry, isic_section_name=="Manufacturing")

newggslopegraph(dataframe = industrySlopeDf,
                Times = year,
                Measurement = net_per_10K,
                Grouping = industry_name,
                Title = paste("Net Industry Migration for",industryCountry,"for",industrySection,"section"),
...
skillCountry <- "Singapore"
skillGroup <- "Tech Skills"

skillSlopeDf <- skillMigrationPivot %>%
  filter(country_name == skillCountry, skill_group_category==skillGroup)

newggslopegraph(dataframe = skillSlopeDf,
                Times = year,
                Measurement = net_per_10K,
                Grouping = skill_group_name,
                Title = paste("Net Skill Migration for",skillCountry,"for",skillGroup,"category"),
                #SubTitle = "Based on: Edward Tufte, Beautiful Evidence, 174, 176.",
                Caption = NULL
                )
