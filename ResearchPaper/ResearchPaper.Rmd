...
The VISTAS application utilises the following analytical techniques.
...
2. Scatter Plot: The interactive scatter plot visualises values for two variables (among GDP per capita growth, employment growth, industry migration or skill migration) and is coloured by year.
