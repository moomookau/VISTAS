...
![](images/01_introduction.png){width="80%"}
...
![](images/03-tooltip.png){width="80%"}

Across each tab, there are two help buttons and many tooltips.

![](images/04-info-user-guide.png){width="80%"}
...
3.  Spinning wheels are added to signify that the visualisations are being generated.
    ...
    ![](images/07-spinning%20wheel.png){width="80%"}
...
![](images/08-scatter.png){width="80%"}
...
![](images/09-correlation.png){width="80%"}
...
![](images/10-choropleth.png){width="80%"}
...
The geofacet has two types of visualisations, line graph and bar graphs. These graphs are shown based on the user inputs, specifically the number of countries, industries or skills they select.

![](Images/13-facet-bar.png){width="80%"}
...
4.  Once you have selected the above, click on "Render!". The spinning wheel indicates that the geofacets are loading. Once completed, the visualization will show.
    ...
    To reset your selections for Industry migration and Skills migration, go to Type of Migration to View, select country, then the industries and skills that you've selected will reset. Then repeat Steps 2-4 again.
